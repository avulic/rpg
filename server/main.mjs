...
player.onConnected = async (player2) => {
  ...
  if (!player2.server.module.has("server.player.onAuth")) {
    player2.setGraphic("hero");
    player2.setHitbox(16);
...
const globalConfig = { "startMap": "simplemap", "start": { "map": "simplemap", "graphic": "hero", "hitbox": [16, 16] }, "name": "My Game" };
